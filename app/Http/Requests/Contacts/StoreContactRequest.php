...
class StoreContactRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'identification_number' => ['required', 'string', 'max:50', 'unique:contacts,identification_number'],
    ...
    {
        return [
            'identification_number.unique' => 'Ya existe un contacto con este número de identificación.',
